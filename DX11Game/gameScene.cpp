...
GameScene::GameScene(EStage stage)
{
	...
	case STAGE_1:	// ステージ1
		...
		{
			m_pBuliding[i].Create(XMFLOAT3(-3900 + i * 300, 10, 0), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
		...
		for (int i = 0; i < 3; i++)  // 右側
		{
			for (int j = 0; j < 3; j++)
			{
				m_pBuliding[i * 3 + 8 + j].Create(XMFLOAT3(-900 + i * 300, 10, 0 + j * 300), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
			}
		}
		for (int i = 0; i < 11; i++)  //真ん中横
		{
			m_pBuliding[i + 17].Create(XMFLOAT3(-3300 + i * 300, 10, 900), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}

		for (int i = 0; i < 11; i++)  // 後横
		{
			m_pBuliding[i + 28].Create(XMFLOAT3(-3900 + i * 300, 10, 1800), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}

		for (int i = 0; i < 2; i++)  // 追い風の後の壁
		{
			m_pBuliding[i + 39].Create(XMFLOAT3(-600 + i * 300, 10, 3600), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));  // 後ろ
		}
		...
		for (int i = 0; i < 25; i++)  // 端
		{
			for (int j = 0; j < 2; j++)
			{
				m_pBuliding[i * 2 + 41 + j].Create(XMFLOAT3(-4200 + j * 4200, 10, -2100 + i * 300), XMFLOAT3(10.0f, 8.0f + rand() % 5, 10.0f));
			}
		}

		for (int i = 0; i < 13; i++)  // ゴールの後ろ
		{
			m_pBuliding[i + 91].Create(XMFLOAT3(-3900 + i * 300, 10, 5100), XMFLOAT3(10.0f, 8.0f + rand() % 5, 10.0f));
		}
	...
	case STAGE_2:	// ステージ2
		...
		for (int i = 0; i < 5; i++)  // プレイヤー初期値の前
		{
			for (int j = 0; j < 2; j++)
			{
				m_pBuliding[i * 2 + j].Create(XMFLOAT3(-2600 + i * 600, 10, 0 + j * 600), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
			}
		}
		for (int i = 0; i < 26; i++) // 横
		{
			for (int j = 0; j < 2; j++)
			{
				m_pBuliding[i + j * 26 + 10].Create(XMFLOAT3(-3200 + j * 3600, 10, -2700 + i * 300), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
			}
		}

		for (int i = 0; i < 11; i++) // ゴール後ろ 
		{
			m_pBuliding[i + 62].Create(XMFLOAT3(-2900 + i * 300, 10, 4800), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}

		for (int i = 0; i < 11; i++) // プレイヤー初期値の後ろ
		{
			m_pBuliding[i + 73].Create(XMFLOAT3(-2900 + i * 300, 10, -2700), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
	...
	case STAGE_3:	// ステージ3
		...
		for (int i = 0; i < 30; i++)  // 横
		{
			for (int j = 0; j < 2; j++)
			{
				m_pBuliding[i + j * 30].Create(XMFLOAT3(-3650 + j * 4500, 10, -2600 + i * 300), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
			}
		}
		for (int i = 0; i < 15; i++)  // ゴール後ろ
		{
			m_pBuliding[i + 60].Create(XMFLOAT3(-3350 + i * 300, 10, 5800), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
		for (int i = 0; i < 15; i++)  // プレイヤー初期値の後ろ
		{
			m_pBuliding[i + 75].Create(XMFLOAT3(-3350 + i * 300, 10, -2600), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
		for (int i = 0; i < 4; i++)  // 障害物
		{
			for (int j = 0; j < 2; j++)
			{
				for (int k = 0; k < 2; k++)
				{
					for (int l = 0; l < 2; l++)
					{
						m_pBuliding[l + k * 2 + j * 4 + i * 16 + 90].Create(XMFLOAT3(-2150 + k * 300 + j * 1200, 10, 0 + l * 300 + i * 1200), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
					}
				}
			}
		}
	...
	case STAGE_4:	// ステージ4
		...
		for (int k = 0; k < 5; k++)  // 障害物
		{
			for (int l = 0; l < 4; l++)
			{
				for (int j = 0; j < 4; j++)
				{
					for (int i = 0; i < 4; i++)
					{
						m_pBuliding[i + j * 4 + 64 * k + l * 16].Create(XMFLOAT3(-3900 - 330 * i + 2000 * l, 10, 2000 * k + j * 350), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		...
		for (int i = 0; i < 45; i++)  // 横
		{
			for (int j = 0; j < 2; j++)
			{
				m_pBuliding[i * 2 + j + 320].Create(XMFLOAT3(-5900 + j * 9000, 10, -2100 + i * 300), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
			}
		}
		for (int i = 0; i < 27; i++)  // ゴールの後ろ
		{
			m_pBuliding[i + 410].Create(XMFLOAT3(-5600 + i * 320, 10, 11100), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
		for (int i = 0; i < 27; i++)  // プレイヤー初期値の後ろ
		{
			m_pBuliding[i + 437].Create(XMFLOAT3(-5600 + i * 320, 10, -2100), XMFLOAT3(10.0f, 10.0f + rand() % 5, 10.0f));
		}
		// ゴールUI位置初期化
...
void GameScene::Update()
{
	...
	for (int i = 0; i < MAX_BULIDING; i++)
	{
		...
		if (GetModelPos().x + GetModelCollisionSize().x / 2 > m_pBuliding[i].GetPos().x + 310 && GetModelPos().x - GetModelCollisionSize().x / 2 < m_pBuliding[i].GetPos().x + 502 &&
