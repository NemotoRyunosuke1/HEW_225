...
float CSound::m_sBGMVolume = 0.5f;
float CSound::m_sSEVolume = 0.5f;
...
void CSound::SetBGMVolume(float volume)
{
	m_sBGMVolume = volume;
}
void CSound::SetSEVolume(float volume)
{
	m_sSEVolume = volume;
}
float CSound::GetBGMVolume()
{
	return m_sBGMVolume;
}
float CSound::GetSEVolume()
{
	return m_sSEVolume;
}
// BGMクラス コンストラクタ
