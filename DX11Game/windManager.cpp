...
WindManager::WindManager(EStage stage)
{
	...
	case STAGE_2:
		...
		m_pWind[6].Create(XMFLOAT3(-100.0f, 800.0f, 1300.0f), XMFLOAT3(1000.0f, 300.0f, 300.0f), XMFLOAT3(-1.0f, 0.0f, 1.0f));  // 左追い風
		m_pWind[7].Create(XMFLOAT3(-1000.0f, 200.0f, 2000.0f), XMFLOAT3(200.0f, 500.0f, 300.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));    // 上昇気流1
