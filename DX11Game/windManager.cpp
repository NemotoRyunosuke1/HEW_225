...
WindManager::WindManager(EStage stage)
{
	...
	case STAGE_2:
		...
		// ゴール上昇気流
		m_pWind[8].Create(XMFLOAT3(-950.0f, 500.0f, 3600.0f), XMFLOAT3(300.0f, 1000.0f, 300.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));    // 上昇気流
	...
	case STAGE_4:
		...
		m_pWind[10].Create(XMFLOAT3(-1000.0f, 1000.0f, 9500.0f), XMFLOAT3(600.0f, 1200.0f, 600.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));  // ゴール
